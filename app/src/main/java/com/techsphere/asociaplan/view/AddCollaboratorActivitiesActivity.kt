...
class AddCollaboratorActivitiesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        idActividad=(intent?.extras?.getInt("idActividad")) as Int
    ...
    fun cargarColaboradores(view: Context){
        ...
        CoroutineScope(Dispatchers.IO).launch{
            ...
            withContext(Dispatchers.Main){
                adap = Add_Colaboradores_Adapter(colaboradores, 0,idActividad, false)
                rv.adapter=adap
