...
class eventos_actividad : AppCompatActivity() {
    private lateinit var rv : RecyclerView
    private lateinit var adap : Eventos_Actividad_Adapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eventos_actividad)
    ...
    fun cargarEventos(view: Context){
        ...
        CoroutineScope(Dispatchers.IO).launch{
            ...
            withContext(Dispatchers.Main){
                adap = Eventos_Actividad_Adapter(eventos)
                rv.adapter=adap
