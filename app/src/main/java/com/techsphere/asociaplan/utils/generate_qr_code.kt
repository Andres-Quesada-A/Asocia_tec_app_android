...
suspend fun generate_qr_code () : String {
//    val datosString = "Código de Apartado: " + datosApartado.getCodigoApartado() +
//            ", Correo: " + datosApartado.getCorreo() +
//            ", Carnet: " + datosApartado.getCarnet()
